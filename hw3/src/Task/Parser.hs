  ...
  subparser
    ( command "help" (info (pure HELP) (progDesc "Usage guide"))
        <> command
          "cd"
          ( info
              (CD <$> argument str (metavar "DIRECTORY"))
        ...
        <> command
          "mkdir"
          ( info
              (MKDIR <$> argument str (metavar "DIRECTORY"))
              (progDesc "Create directory")
          )
        <> command
          "touch"
          ( info
              (TOUCH <$> argument str (metavar "FILE"))
              (progDesc "Create file")
          )
        <> command
          "cat"
          ( info
              (CAT <$> argument str (metavar "FILE"))
        ...
        <> command
          "rmdir"
          ( info
              (RMDIR <$> argument str (metavar "DIRECTORY"))
              (progDesc "Remove directory")
          )
        <> command
          "grep"
          ( info
              (GREP <$> argument str (metavar "FILE"))
              (progDesc "Find file in current directory or subdirectories")
          )
        <> command
          "echo"
          ( info
              ( ECHO <$> argument str (metavar "FILE")
                  <*> many
        ...
        <> command
          "ls"
          ( info
              (LS <$> argument str (metavar "FILE"))
              (progDesc "Get file information")
          )
        <> command
          "stat"
          ( info
              (STAT <$> argument str (metavar "DIRECTORY"))
